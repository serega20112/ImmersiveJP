...
from src.infrastructures.observability import HttpMetricsCollector, log_event
from src.infrastructures.security import RateLimiter
from src.presentation.http.web.csrf import validate_csrf
from src.presentation.http.web.error_responses import (
    apply_default_response_headers,
    build_application_error_response,
)
from src.presentation.http.web.errors import (
    ApplicationError,
