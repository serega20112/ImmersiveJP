...
from src.backend.use_case.onboarding.complete_onboarding import InvalidOnboardingDataError
...
async def complete_onboarding(
    ...
    try:
        ...
        flash(request, 'Стартовые карточки готовы. Можно заходить в dashboard.', 'success')
        return redirect_to_route(request, 'dashboard.dashboard_page')
