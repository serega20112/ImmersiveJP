...
from src.application.dto.auth_dto import LoginDTO, RegistrationDTO, VerificationDTO
from src.application.use_cases.auth.login_user import EmailNotVerifiedError, InvalidCredentialsError
from src.application.use_cases.auth.register_user import (
    EmailAlreadyExistsError,
    InvalidRegistrationDataError,
)
from src.application.use_cases.auth.verify_email import InvalidVerificationCodeError
from src.infrastructures.di_containers.service_dependencies import AuthServiceDependency
from src.presentation.http.api.v1.helpers import (
    clear_auth_cookies,
    redirect_to_route,
    set_auth_cookies,
)
