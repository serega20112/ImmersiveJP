...
from src.presentation.http.web.constants import CSRF_FIELD_NAME
from src.presentation.http.web.csrf import ensure_csrf_token
...
async def render_template(request: Request, template_name: str, **context):
    # Ленивый импорт разрывает цикл web <-> di_containers.current_user.
